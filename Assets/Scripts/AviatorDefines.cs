...
public struct AviatorColors {
    ...
    public static Color Fog = new Color(r: 247 / 255f, g: 217 / 255f, b: 170 / 255f);
    ...
    public static Color Blue = GetColor("0x68c3c0");
    private static Color GetColor(string hex)
    {
        hex = hex.PadRight(10, 'f');
        return new Color(r: Convert.ToInt32(hex.Substring(2, 2), 16) / 255f, g: Convert.ToInt32(hex.Substring(4, 2), 16) / 255f, b: Convert.ToInt32(hex.Substring(6, 2), 16) / 255f);
    }
